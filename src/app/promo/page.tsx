...
//   - ultima sectiune ajunge la varf (la referinta ramanea la e = 0,875): 90svh cu spatiul in plus jos. Proba
//     (`tests/browser/promo.spec.ts`) o dovedeste cu subsolul SCOS in proba, nu pe pagina servita;
//   - SUBSOLUL RAMANE, NEREZOLVAT: fisa cere pagina fara subsol, dar subsolul sta in layout-ul inghetat si nu
//     are un comutator pe pagina. Pe pagina servita el adauga ~540 px la 1440 si ~700 px la 390, iar la
//     derularea maxima CTA-ul a trecut de varf si iese (opacitate ~0,1 la 1440, 0 la 390). Cererea catre
//     dispecer (un comutator de subsol in layout pentru sablonul cinema) e in `nemasurat` din raportul feliei.
//     Pagina pune tema inchisa, deci subsolul e pe varianta inchisa, ca pe paginile de functionalitate.
