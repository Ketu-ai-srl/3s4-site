...
//
// Aceleasi abateri ca pe /promo (un singur h1, contrastul, ultima sectiune la varf, subsolul inchis ramas
// din layout); in plus butonul CTA isi schimba la hover doar fundalul, ca la referinta.
