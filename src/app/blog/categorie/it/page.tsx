// `/blog/categorie/it`: pagina categoriei (sablonul blog-C). Statica si in `RUTE`, ca listarea
...
export function generateMetadata(): Metadata {
  return metadataCategorie("it");
}

export default function PaginaCategoriei() {
  return <PaginaCategorie categorie="it" articole={toateArticolele()} />;
}
