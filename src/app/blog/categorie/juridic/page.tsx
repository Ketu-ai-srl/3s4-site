// `/blog/categorie/juridic`: pagina categoriei (sablonul blog-C). Statica si in `RUTE`, ca listarea
...
export function generateMetadata(): Metadata {
  return metadataCategorie("juridic");
}

export default function PaginaCategoriei() {
  return <PaginaCategorie categorie="juridic" articole={toateArticolele()} />;
}
