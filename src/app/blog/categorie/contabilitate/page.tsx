// `/blog/categorie/contabilitate`: pagina categoriei (sablonul blog-C). Statica si in `RUTE`, ca listarea
...
export function generateMetadata(): Metadata {
  return metadataCategorie("contabilitate");
}

export default function PaginaCategoriei() {
  return <PaginaCategorie categorie="contabilitate" articole={toateArticolele()} />;
}
