...
// deci ajunge singura la varf fara ajutorul subsolului (proba `tests/browser/promo.spec.ts`, cu subsolul scos
// in proba). Pe pagina servita subsolul inca exista: la derularea maxima ultima sectiune a trecut de varf.
