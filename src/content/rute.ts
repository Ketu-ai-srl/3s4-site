...
export const RUTE: Ruta[] = [
  ...
  },
  {
    ...
    descriere: "Scrieți regula o dată, iar fiecare act nou pleacă singur spre omul care trebuie să se ocupe de el.",
    inHarta: true,
  },
  {
    cale: "/functionalitati/portal-clienti",
    scurt: "Clienții își văd actele",
    descriere: "Clientul își ia singur actele din portal, iar fiecare vede doar partea lui, cu jurnal de acces.",
    inHarta: true,
  },
  ...
  // <<felie:blog>>
  // Blogul nu are intrari aici: listarea, categoriile si articolele sunt rute DINAMICE, nascute din
  // registrul blogului (`src/content/blog/registru.ts`). Cu registrul gol nu exista niciuna, iar cu
  // primul articol `caiArticole` le adauga in caile existente, deci si in navigatie.
