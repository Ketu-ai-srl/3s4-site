...
// motivul e scris in `TARI_NEVERIFICATE`). Tot din motivul asta lipseste termenul de transmitere
// in RO e-Factura: forma lui in vigoare din 2026 nu a putut fi deschisa in textul actului.
//
...
export const SURSE = {
  roGhid: {
    id: "ro-ghid-efactura",
    eticheta: "ANAF, ghidul e-Factura",
    autoritate: "ANAF",
