...
export const TREI_REGULI = {
  ...
  carduri: [
    ...
    },
    {
      ...
      text: "Factura este un fișier XML pe standardul european EN 16931, cu regulile naționale RO_CIUS. Programul destinatarului o citește direct, fără ca cineva să transcrie rândurile. PDF-ul rămâne o vedere a ei, bună de citit, dar documentul este XML-ul.",
    },
    {
      iconita: "archive",
