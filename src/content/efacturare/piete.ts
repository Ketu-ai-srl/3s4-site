...
export const PIETE: Piata[] = [
  ...
  },
  {
    ancora: "romania",
    tara: "România",
    ce: "Facturile dintre firmele stabilite în România trec prin RO e-Factura. Raportarea SAF-T (D406) se depune separat.",
    ...
    format: "XML EN 16931 cu RO_CIUS; D406 lunar sau trimestrial",
    surse: ["roGhid", "roSaft"],
  },
  {
