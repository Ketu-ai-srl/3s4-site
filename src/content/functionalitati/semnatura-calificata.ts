...
export const DRUM = {
  titlu: "Șapte drumuri pentru o semnătură.",
...
export const TERMENE = {
  ...
  titlu: "Și semnăturile au termen.",
  paragraf:
    "Certificatul unui semnatar e valabil o perioadă limitată. Termenele actelor stau deja în registrul arhivei 3S; integrarea în curs cu furnizorii acreditați va pune alături și data certificatului, ca actele atinse să se vadă din timp.",
  modul: "registru · certificate",
  interval: "următoarele 60 de zile",
  banda: [
...
export const CONTRAST_SEMNATURA = {
  ...
  inainte: {
    ...
    metrici: [
      ...
      { valoare: "PDF scanat", cheie: "În dosar", calitativ: "rau" },
    ],
  },
  ...
  acum: {
    ...
    metrici: [
      ...
      { valoare: "fișierul", cheie: "În dosar", calitativ: "bun" },
    ],
  },
  punte: "hârtie · fișier",
} as const;
