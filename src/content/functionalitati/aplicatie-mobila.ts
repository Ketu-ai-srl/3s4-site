...
export const ANXIETATE_MOBILA = {
  randuri: ["Avizul a rămas în mapa colegului?", "Clientul sună să întrebe de factură?"] as const,
...
export const TELEFON = {
  ...
  ecrane: [
    { numar: "01", nume: "Poza", legenda: "din ea iese o scanare curată" },
    { numar: "02", nume: "Etichetele", legenda: "clientul, felul actului, luna" },
    { numar: "03", nume: "Dosarul", legenda: "contabila îl deschide la birou" },
  ] as const,
...
export const CONTRAST_MOBILA = {
  ...
  inainte: {
    ...
    metrici: [
      { valoare: "seara, de mână", cheie: "Clasarea actelor" },
      { valoare: "în mapa agentului", cheie: "Unde stă avizul" },
      { valoare: "a doua zi", cheie: "Factura pleacă", calitativ: "rau" },
      { valoare: "niciuna", cheie: "Copia la birou", calitativ: "rau" },
    ],
  },
  acum: {
    titlu: "Acum",
    ...
    ora: "11:21",
    document: "aviz_0412_gama.pdf",
    pasi: ["Scanare din poză", "Client · aviz · aprilie", "În dosarul Gama"] as const,
    loc: "Pe teren",
    confirmare: "în dosar, la birou",
    declaratie: "Exemplu cu date fictive: aplicația 3S cu avizul trimis",
    metrici: [
      { valoare: "pe loc, pe teren", cheie: "Clasarea actelor" },
      { valoare: "la client", cheie: "Unde stă avizul" },
      { valoare: "în aceeași zi", cheie: "Factura pleacă", calitativ: "bun" },
      { valoare: "în dosarul clientului, cu etichete", cheie: "Copia la birou", calitativ: "bun" },
    ],
  },
} as const;
