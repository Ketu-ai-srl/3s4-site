...
describe('calendarul /instrumente/termene.ics', () => {
  ...
  it('are termene romanesti SI europene, toate dupa ziua verificarii', () => {
    ...
    // D406 lunar: ultima zi calendaristica a lunii urmatoare. Primul termen dupa ziua verificarii
    // (25.09.2026) e al perioadei august 2026, pe 30 septembrie 2026 - nu se sare.
    expect(lista[0].data).toBe('2026-09-30')
    expect(lista[0].titlu).toContain('august 2026')
  ...
  it('termenul de transmitere in RO e-Factura nu apare cat forma lui din 2026 nu e verificata', () => {
    ...
    // Pagina numeste termenul fara cifra si trimite la materialul ANAF despre OUG 89/2025.
    expect(efacturare).toContain('termenul legal de transmitere')
    expect(efacturare).toContain('facturare_electronica_89.pdf')
