...
describe('completitudinea, pentru livrare (S4-5)', () => {
  it('pe lumea S4-1 multe legaturi sunt ascunse, si lista lor se poate citi', () => {
    // Lumea S4-1 (doar startul) se fabrica (25.09): pragul pus pe CAI_EXISTENTE ar fi picat pe primul
    // lot care aduce corect destule rute, desi proba nu apara nimic legat de cate rute exista azi.
    const lipsa = ascunse(toateLegaturileNavigatiei(), multimeaCailor([{ cale: '/' }]))
