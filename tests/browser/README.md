...
| Sigla (`fundatie-sigla`) | pe pixeli: fiecare rand de litere al siglei, in antet (1440), in sertar si in subsol (1440, 390), cel putin cat majusculele unui text de 11 px masurat in aceeasi pagina; la 390 antetul arata doar iconita, taiata, nu strivita; martorul pozitiv e sigla completa la 40 px, prinsa ca ilizibila | `docs/design/DIRECTIA.md`, "Sigla" |
